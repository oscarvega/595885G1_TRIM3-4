...
UPDATE `a`.`persona` SET `sexo`='masculino' WHERE `tipo_documento`='cc' and`numero_documento`='51454';
UPDATE `a`.`persona` SET `direccion`='kr 123 siempre viva' WHERE `tipo_documento`='cc' and`numero_documento`='51454';
UPDATE `a`.`persona` SET `telefono`='2341233124' WHERE `tipo_documento`='cc' and`numero_documento`='51454';
